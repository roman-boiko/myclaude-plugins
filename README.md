...
```bash
# From marketplace
/plugin install dd-plugins

# Local testing
claude --plugin-dir /path/to/mycalude-plugins
```

## Skills

### Pricing Calculator (`/dd-plugins:calculate-pricing`)
...
### Datadog Expert (`/dd-plugins:datadog-expert`)
...
```
# Pricing example
/dd-plugins:calculate-pricing 50 hosts, 200 containers, and 15GB/day of log ingestion

# Technical example
/dd-plugins:datadog-expert How do I configure the Datadog Agent to collect custom metrics from a Python app?
```
